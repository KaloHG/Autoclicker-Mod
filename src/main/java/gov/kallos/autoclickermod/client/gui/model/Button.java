package gov.kallos.autoclickermod.client.gui.model;
...
public class Button extends Clickable {
    ...
    public Button(@Nullable Text text) {
        ...
        this.button = new ButtonWidget.Builder(text, null)
                .dimensions(0, 0, this.getSize().x, this.getSize().y).build();
    }
    ...
    private void reconstructButton() {
        ...
        this.button = new ButtonWidget.Builder(this.text, null)
                .dimensions(this.button.getX(), this.button.getY(), this.getSize().x, this.getSize().y).build();
